...
# END Problem 12
    ...
    def construct(cls, gamestate):
        ...
        """
        # BEGIN Problem 12
        if gamestate.onstage == False:
            gamestate.onstage = True
    ...
    def action(self, gamestate):
        ...
        super().action(gamestate) #This is so that the queenant still throws the leaf.
...
class GameState:
    ...
    def __init__(self, strategy, beehive, ant_types, create_places, dimensions, food=2):
        ...
        self.onstage = False #Checks if a queen is already present
