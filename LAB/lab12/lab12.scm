...
(define (distance city-a city-b) (sqrt (+ (expt (- (get-lat city-b) (get-lat city-a)) 2) (expt (- (get-lon city-b) (get-lon city-a)) 2)))
)

(define (closer-city lat lon city-a city-b)
  (if (> (distance (make-city 'x lat lon) city-a) (distance (make-city 'x lat lon) city-b))
    (get-name city-b)
    (get-name city-a)))
...
(define (teacher-hold-class teacher)
  ...
  (map (lambda(s) (student-attend-class s (teacher-get-class teacher))) (teacher-get-students teacher))))
